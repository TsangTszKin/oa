        ...
        <div class="right-list">
          <div class="mod-config">
            <div class="ctrlbtn-list">
              ...
              <el-button class="ctrlbtn-list-float" size="mini" type="primary" @click="tagHandle(null, 3, false)" :disabled="dataListSelections.length < 1" icon="el-icon-check">关注</el-button>
              <el-button class="ctrlbtn-list-float" size="mini" type="danger" @click="tagHandle(null, 3, true)" :disabled="dataListSelections.length < 1" icon="el-icon-close">取消关注</el-button>
            ...
            <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()" class="search-from">
              <el-row>
                <el-col :span="4">
                  <el-form-item>
                    <el-select v-model="dataForm.stateMail" @change="changeMailstate()" placeholder="状态" clearable>
                ...
                <el-col :span="4">
                  <el-form-item>
                    <el-input size="mini" v-model="dataForm.sendUser" placeholder="发件人" clearable></el-input>
                  </el-form-item>
                </el-col>
              </el-row>
  ...
  export default {
    data () {
      return {
        ...
        dataForm: {
          // orgName: '', // 企业名称
          stateMail: '',    // 状态
          readMail: undefined,    // 已读
          attentionMail: undefined,    // 已关注
          dirId: '',    // 文件夹id
          timeSlot: '',   // 时间列表
          urgentLevel: '', // 紧急程度
          theme: '', // 主题
        ...
        columnList: [
          ...
          {label: '状态', prop: 'internalMailLinkUserVo', columnName: 'internalMailLinkUserVo', type: '', show: true, operation: [{ type: 'iconSvg', name: 'readMail' }, { type: 'iconSvg', name: 'topMail' }, { type: 'iconSvg', name: 'attentionMail' }], headerAlign: 'left', align: 'left', minWidth: '80', showOverflowTooltip: true},
          ...
          {label: '发件人', prop: 'sendUser', columnName: 'sendUser', type: '', show: true, operation: [{ type: 'view' }], headerAlign: 'left', align: 'left', minWidth: '100', showOverflowTooltip: true},
          ...
          {label: '操作', type: '', fixed: 'right', show: true, operation: [{type: 'reply'}, {type: 'forwarding'}, {type: 'placedTop', objName: 'internalMailLinkUserVo', topName: 'topMail'}, {type: 'starSvgicon', objName: 'internalMailLinkUserVo', topName: 'starMail'}], headerAlign: 'left', align: 'left', width: '150'}
    ...
    methods: {
      ...
      changeMailstate (item) {
        if (this.dataForm.stateMail === '0') {
          this.dataForm.readMail = false
          this.dataForm.attentionMail = undefined
        } else if (this.dataForm.stateMail === '1') {
          this.dataForm.readMail = true
          this.dataForm.attentionMail = undefined
        } else if (this.dataForm.stateMail === '2') {
          this.dataForm.readMail = undefined
          this.dataForm.attentionMail = true
        }
        this.doFilter()
      },
      // 查询
