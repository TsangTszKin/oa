  ...
  <div>
    <el-dialog
      ...
      <div v-loading="!submitAble" :style="{paddingBottom: footerShow ? '' : '50px'}">
        <sende-mail ref="sendeMail" :ueId="'update'" :changeMail="true" @refreshDataList="refreshDataList" @formDataNopass="formDataNopass" @write-a-letter="writeALetter"></sende-mail>
      </div>
    ...
    methods: {
      init (id) {
        ...
        this.$nextTick(() => {
          ...
          this.$refs.sendeMail.init(this.dataForm.id)
        })
      },
