<template>
  <div class="mod-config">
    ...
    >
      ...
      <el-table-column prop="name" header-align="center" align="center" label="文号定义"></el-table-column>
      <el-table-column prop="name" header-align="center" align="center" label="文号模式"></el-table-column>
      <el-table-column prop="name" header-align="center" align="center" label="选择的文件类型"></el-table-column>
      <el-table-column prop="name" header-align="center" align="center" label="来文类型"></el-table-column>
