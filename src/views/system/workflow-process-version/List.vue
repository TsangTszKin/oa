...
<template>
  <div class="mod-config">
    ...
    >
      ...
      <el-table-column prop="isSuspended" header-align="center" align="center" label="当前状态">
        <template slot-scope="scope">
          <el-tag v-if="scope.row.isSuspended" type="warning">已挂起</el-tag>
          <el-tag v-else>已激活</el-tag>
        </template>
      </el-table-column>
      ...
      >
        <template slot-scope="scope">
          <el-button type="text" size="small" @click="history(scope.row.key)">历史版本</el-button>
          ...
          >激活</el-button>
          <el-button type="text" size="small" @click="changeStatus(0, scope.row.id)" v-else>挂起</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
